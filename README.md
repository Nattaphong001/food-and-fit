...
**ต่อยอด — Smart Auto Calorie (เวทเทรนนิ่ง):** เดิมให้ผู้ใช้เลือกความหนัก 3 ระดับเอง (เบา/กลาง/หนัก) เพื่อกำหนด METs แต่ตรวจสอบแล้วพบว่าฟีเจอร์นี้ไม่เคยทำงานจริง — แอปมือถือไม่เคยส่งค่าที่เลือกขึ้น API เลย เปลี่ยนมาให้ระบบอนุมาน METs อัตโนมัติแทน โดยไม่ต้องพึ่งสายรัดวัดหัวใจ: เลือก **Dynamic Base MET** ต่อเซตจากตาราง lookup ของ Reps + เวลาพักหลังเซตนั้น (อ้างอิง 2024 Adult Compendium of Physical Activities — เช่น พัก <30 วิ = MET 8.0, พัก ≥60 วิ + Reps 8-15 = MET 3.5) แล้วเฉลี่ยเป็น Session Base MET ของทั้งเซสชัน ก่อนเข้าสูตร net METs เดิมด้านบนตรงๆ — %1RM เทียบสถิติที่ดีที่สุดของสมาชิกยังคำนวณไว้แสดงเป็น label ความหนัก (เบา/กลาง/หนัก) แต่ไม่มีผลต่อพลังงานที่คำนวณได้ เพราะเอกสารอ้างอิงยังไม่มีสูตร/เกณฑ์ตัวเลขที่แปลงน้ำหนักที่ยกเป็นสัมประสิทธิ์ปรับ MET
