...
class _AppAlertWidgetState extends State<_AppAlertWidget>
  ...
  Color get _color {
    switch (widget.type) {
      case AppAlertType.success: return AppColors.success;
      case AppAlertType.error:   return AppColors.dangerText;
      case AppAlertType.warning: return AppColors.warningText;
      case AppAlertType.info:    return AppColors.infoText;
    }
  }
  ...
  // ทุกประเภทพื้นเข้มพอสำหรับตัวหนังสือขาวอยู่แล้ว (ดูค่าสีใน _color ด้านบน)
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    widget.message,
                                    style: AppTextStyles.tableHeader.copyWith(color: _fgColor),
                                    maxLines: 2,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.message,
                            style: AppTextStyles.tableHeader.copyWith(color: AppColors.textPrimary),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
