...
class AdminDataTable extends StatefulWidget {
  ...
  // หัวคอลัมน์ action ขวาสุด — ค่าเริ่มต้น "จัดการ" เหมาะกับตารางที่มีปุ่มแก้ไข/ลบจริง
  // ส่งค่าว่างให้หน้าที่ปุ่มเป็นแค่ "ดูรายละเอียด" อย่างเดียว (เช่นรายชื่อสมาชิก อ่านอย่างเดียว)
    ...
    final actionsHeader = SizedBox(
      ...
      child: Padding(
        ...
        child: Align(
          ...
          alignment: Alignment.center,
          child: Text(widget.actionColumnLabel, style: AppTextStyles.tableHeader, maxLines: 1, softWrap: false, overflow: TextOverflow.visible),
        ),
      ),
    );
