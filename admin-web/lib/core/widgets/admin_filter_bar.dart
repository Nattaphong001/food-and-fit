...
class AdminFilterBar extends StatefulWidget {
  ...
  // false = ซ่อนช่องค้นหา ใช้เมื่อหน้านั้นมีแค่ตัวกรองแบบ chip พอ (เช่น กลุ่มกล้ามเนื้อ/ประเภทโภชนาการ
  // ที่รายการน้อยพอมองหาด้วยตาเปล่าได้ ไม่จำเป็นต้องมีช่องค้นหาซ้ำ)
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      for (final (i, w) in widget.trailing.indexed) ...[
                        SizedBox(width: (widget.showSearchBox || i > 0) ? 12 : 0),
                        w,
                      ],
