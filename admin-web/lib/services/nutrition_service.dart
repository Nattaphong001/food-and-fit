// DEPRECATED - ยังไม่มี view ไหนเรียกใช้ (manage_food_items_view / manage_nutrition_categories_view เขียน http เรียกเองในไฟล์ view)
// รอ cleanup พร้อมกับหนี้ service ของ cardio/muscle_group/plan_template (ดู memory: service-layer-debt)
