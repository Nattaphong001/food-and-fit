              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(children: [
                      Expanded(child: Text(item == null ? 'เพิ่มท่าฝึกเวทเทรนนิ่ง' : 'แก้ไขท่าฝึกเวทเทรนนิ่ง', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
    ...
    final content = Column(
      ...
      children: [
        AdminPageHeader(
          ...
          addLabel: 'เพิ่มท่าฝึกเวทเทรนนิ่ง',
        ),
        // --------------------------------------------
        // [FEATURE] COMMON_UI
