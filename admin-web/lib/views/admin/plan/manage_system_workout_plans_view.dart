...
class _ManageSystemWorkoutPlansViewState extends State<ManageSystemWorkoutPlansView> {
                ...
                children: [
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Text(item == null ? 'เพิ่มแผนแนะนำ' : 'แก้ไขแผนแนะนำ', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black87))),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        AdminPageHeader(
          breadcrumb: const ['แผนการฝึก', 'แผนแนะนำ'],
          onAdd: () => _showForm(),
          addLabel: 'เพิ่มแผนแนะนำ',
        ),
        AdminFilterBar(
        ...
        //     SizedBox(width: 6),
        //     Text('คลิกที่การ์ดเพื่อดู/จัดการรายละเอียดแผนแนะนำ (ท่าฝึกแต่ละวัน)', style: TextStyle(fontSize: 12, color: AppColors.textMuted)),
        //   ]),
        // ),
        Expanded(
