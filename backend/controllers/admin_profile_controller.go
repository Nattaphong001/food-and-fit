...
// UpdateAdminProfile - PUT /api/admin/profile (sys_full_name / sys_organization เท่านั้น
// ไม่แก้ sys_email หรือ sys_password_hash ผ่าน endpoint นี้ — sys_start_date แก้เองไม่ได้แล้ว
// (ระบบตั้งอัตโนมัติตอน login ครั้งแรกจริงเท่านั้น ดู AdminLogin)
