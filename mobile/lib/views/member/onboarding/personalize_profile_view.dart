...
class _PersonalizeProfileViewState extends State<PersonalizeProfileView> {
  ...
  // target: 1=ลดน้ำหนัก, 2=เพิ่มน้ำหนัก, 3=รักษาน้ำหนัก (ตรงกับ backend int)
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text("เพื่อให้แผนการฝึกแม่นยำที่สุดสำหรับคุณ", style: TextStyle(color: AppColors.textBody, fontSize: 15)),
      ],
    );
  }
