      ...
      child: Column(
        children: [
          ...
          const Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _BmiLegend(color: Color(0xFFAB7FE8), label: 'ผอมเกินไป'),
              _BmiLegend(color: Color(0xFF3CC446), label: 'สมส่วน'),
        ...
        children: [
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('พลังงานที่เหมาะสมต่อวัน',
