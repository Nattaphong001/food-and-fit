...
class _CardioActivityExerciseViewState extends State<CardioActivityExerciseView>
  ...
  // ปิดสรุปแล้วกลับไปฝึกต่อ — ทั้งปุ่ม X ที่ header และ "ฝึกต่อ" ที่ footer ของสรุปผล
  // เรียกจุดนี้จุดเดียว (pattern เดียวกับ weight_training_exercise_view._resumeWorkout)
  void _resumeWorkout() {
