...
class _ForgotPasswordViewState extends State<ForgotPasswordView> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (result['success']) {
      ...
      // ห้ามใช้ Navigator.pop ธรรมดา — จะกลับไปที่ LoginView instance เดิมที่โหลด
      // รหัสจำไว้ตอน initState ไปแล้วก่อนหน้านี้ ทำให้ field ยังค้างรหัสเก่าแม้ secure
      // storage จะอัปเดตแล้วก็ตาม ต้อง offAllNamed เหมือน pattern logout เพื่อสร้าง
      // LoginView ใหม่ให้ initState โหลดรหัสที่จำไว้ (อัปเดตแล้ว) ใหม่จริงๆ
