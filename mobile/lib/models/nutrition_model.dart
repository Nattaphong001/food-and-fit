...
class Food {
  ...
  final double fiber;
  final String unit;
  // ปริมาณจริงต่อ 1 หน่วยเสิร์ฟ (ntt_serving_weight) — กรัม = 100 เสมอ, ออนซ์แล้วแต่ขนาดแก้ว (6/16/20)
  // ต้องคูณกับ quantity เสมอเวลาโชว์ปริมาณจริง ห้ามเดาว่าเท่ากับ 100 อีกต่อไป
  ...
  factory Food.fromJson(Map<String, dynamic> json) => Food(
        ...
        servingWeight: (json['ntt_serving_weight'] ?? json['serving_weight'] ?? 100) as int,
...
class DailyNutrition {
  ...
  final int mealType;
  final String unit;
  // เหมือน Food.servingWeight — แต่แถวที่ ntt_id เป็น NULL (อาหารกรอกเองไม่ได้เลือกจากระบบ)
  // GORM Preload คืน nested "nutrition" เป็น struct ว่าง ไม่มี ntt_serving_weight ให้อ่าน
  // default 0 ไว้ตรงนี้แล้วให้ตัวคำนวณป้ายถือว่า 0 = "quantity คือปริมาณจริงอยู่แล้ว" (ดู
  // servingAmountLabel ใน core/utils/nutrition_format.dart) ห้าม default 100 เพราะจะผิดกรณีนี้
  final int servingWeight;
  ...
  factory DailyNutrition.fromJson(Map<String, dynamic> json) {
    ...
    return DailyNutrition(
      ...
      servingWeight: (nested?['ntt_serving_weight'] as int?) ?? 0,
    );
  }
}
